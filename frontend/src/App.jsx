    ...
    <div className="dashboard">
      ...
      <div className="grid">
        ...
        <Card
          ...
          value={state?.person && state?.person_distance_m != null ? state.person_distance_m : "—"}
          unit={state?.person && state?.person_distance_m != null ? "m" : ""}
          alert={state?.person && state?.person_distance_m != null && state.person_distance_m < 2}
        />
      </div>
